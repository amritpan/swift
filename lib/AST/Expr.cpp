...
KeyPathExpr::Component
KeyPathExpr::Component::forUnresolvedMethod(Expr *funcExpression,
                                            ASTContext &ctx) {
  return Component({}, funcExpression->getArgs(), {}, Kind::Method, Type(),
                   funcExpression->getArgs()->getLParenLoc(), funcExpression);
}
